		...
		return(
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="jumbotron" style={{'backgroundImage': 'url(./../images/nytimage.jpg)', 'backgroundRepeat': 'no-repeat', 'backgroundPosition': 'center', 'backgroundSize': '100% 100%', 'backgroundAttachment': 'fixed'}}>
